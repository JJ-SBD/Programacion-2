...
public class SumaGUI
{
    ...
    public SumaGUI()
    {
        ...
        lblIns2 =  new JLabel("¿Que numeros vamos a sumar hoy Ferb?");
    ...
    class ManagerBotonCalcular implements ActionListener{
        ...
        try{
            ...
            if(boxSum.getState()){
                ...
                if(n2 == 0.0) {
                    JOptionPane.showMessageDialog(null, "Divsion entre 0", "Advertencia", JOptionPane.WARNING_MESSAGE);
                    return;
                } else {
                res = n1 / n2;
                }
            ...
            JOptionPane.showMessageDialog(null, "Introduce numeros validos", "Error de entrada", JOptionPane.ERROR_MESSAGE);
