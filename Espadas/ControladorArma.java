...
{   
    public static void main(String[] args)
    {
        ...
        //en cada iteracion impirime cada elemento del array
        ...
        {   //responde: si, el objeto es un martillo explosivo
            //entonces casteamos
            MartilloExplosivo Mar = (MartilloExplosivo) currentWeapon;
            System.out.println(Mar.getClass().getName());

            //Dudas:
            //¿porque estamos convirtiendo un martillo explosivo en un martillo explosivo?
            //¿que sentido tiene?
            //¿es esto un lowercast, no parece que lo estemos bajando de nivel?
        }
        ...
        for (int i = 0; i < arsenal.length; i++)
        {
            ...
            //en el &d se imprime el numero de iteracion y en %s el contenido en ese momento del arreglo arsenal
            System.out.printf("El arma en el slot %d se llama %s%n", i, arsenal[i].getNombre());
        }
