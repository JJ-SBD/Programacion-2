...
{   //declaramos los elementos de la GUI
    private Frame frog; 
    private Panel pan1, pan2, pan3, pan4; //4 paneles
    private JLabel lblSaludo, lblIns, lbl, lbl2, lblRes; //los labels son etiquetas con texto
    ...
    private Checkbox boxSum, boxRes, boxMult, boxDiv;
    ...
    public SumaGUI()
    {
        ...
        lblIns =  new JLabel("¿Que numeros vamos a sumar hoy Ferb?");
        lbl = new JLabel("<html>Primer Numero<html>");
        lbl2 = new JLabel("<html>Segundo Numero<html>");
        ...
        boxSum = new Checkbox("Sumar", operaciones, true);
        boxRes = new Checkbox("Restar", operaciones, true);
        boxMult = new Checkbox("Multiplicar", operaciones, true);
        boxDiv = new Checkbox("Dividir", operaciones, true);
    }
    ...
    public void acomodarEnFrame()
    {
        ...
        pan1.add(lblSaludo); //Hola
        pan1.add(lblIns); //que numeros vamos a sumar?
        pan1.add(lbl); //primer numero
        pan1.add(tf1); //textfield 1
        pan1.add(lbl2); //segundo numero
        ...
        frog.add(pan4, BorderLayout.WEST);
        ...
        frog.setSize(500, 300); //tamaño de la ventana
    ...
    class ManagerBotonCalcular implements ActionListener{
        ...
        try{
            ...
            if(boxSum.getState()){
                res = n1 + n2;
            } else if (boxRes.getState()){
                res = n1 - n2;
            } else if (boxMult.getState()){
                res = n1 * n2;
            } else if (boxDiv.getState()){
                if(n2 == 0.0) {
                    JOptionPane.showMessageDialog(null, "Pendejo", "Division entre 0", JOptionPane.WARNING_MESSAGE);
                    return;
                } else {
                res = n1 / n2;
                }
        ...
        } catch (NumberFormatException numeroString) {
            JOptionPane.showMessageDialog(null, "Introduce numeros pinche Mongoloide", "Error de entrada", JOptionPane.ERROR_MESSAGE);
