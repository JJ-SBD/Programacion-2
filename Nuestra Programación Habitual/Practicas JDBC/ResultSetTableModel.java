...
public ResultSetTableModel( String controlador, String url, String usr,
String pswd, String consulta) throws SQLException, ClassNotFoundException
{
...
throw new IllegalStateException ( "No hay conxión a la Base de Datos" );

//determinar la clase de Java de columna
try {
String nombreClase = metaDatos.getColumnClassName( columna +
