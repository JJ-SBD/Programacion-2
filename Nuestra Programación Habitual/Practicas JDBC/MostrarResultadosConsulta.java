...
modeloTabla = new ResultSetTableModel( CONTROLADOR_JDBC,

URL_BASEDEDATOS, USR, PSWD, CONSULTA_PREDETERMINADA );

// establecer objeto JTextArea en el que el usuario escribe las
...
excepcionSQL.getMessage(), "Error en la base de datos", JOptionPane.ERROR_MESSAGE );
...
JOptionPane.showMessageDialog( null,
excepcionSQL2.getMessage(), "Error en la base de datos", JOptionPane.ERROR_MESSAGE );
