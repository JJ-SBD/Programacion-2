...
static final String urlBD = "jdbc:mysql://localhost/Biblio";
...
{
super( "Tabla autores de la base de datos Biblio");
...
conjuntoResultados.getMetaData();
...
{
JOptionPane.showMessageDialog(null,
claseNoEncontrada.getMessage(), "No se encontró el controlador",
