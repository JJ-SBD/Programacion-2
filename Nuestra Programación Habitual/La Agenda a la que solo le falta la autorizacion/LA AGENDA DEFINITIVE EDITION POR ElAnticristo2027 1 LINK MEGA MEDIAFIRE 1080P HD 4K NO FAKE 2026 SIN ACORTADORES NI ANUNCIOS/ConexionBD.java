...
public class ConexionBD
{
    ...
    final String pwd = "kronos";
    //con que controlador estoy trabajando // donde esta: puerto por donde escucha
    final String dburl = "jdbc:mysql://localhost:3306/bdalumno?zeroDateTimeBehavior=CONVERT_TO_NULL";
    ...
    public Connection obtenerConexion() throws Exception
    {
        try{
            ...
            System.out.println("El driver parallel lines no carga"); //vas a avisar que no cargo
            cnfe.printStackTrace(); //imprime la traza del error

        }catch(SQLException sqle){ // por si no hay conexion
            conn = null;
            System.out.println("La conexion es Bullshit");
        }
